...
#if UNITY_EDITOR
using BetterStreamingAssetsImp = Better.StreamingAssets.BetterStreamingAssets.EditorImpl;
#elif UNITY_ANDROID
using BetterStreamingAssetsImp = Better.StreamingAssets.BetterStreamingAssets.ApkImpl;
#else
using BetterStreamingAssetsImp = Better.StreamingAssets.BetterStreamingAssets.LooseFilesImpl;
#endif
